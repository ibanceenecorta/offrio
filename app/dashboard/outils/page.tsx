    ...
    <div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="glass grad-border p-6">
          <h2 className="font-heading text-xl mb-1" style={{ color: "var(--text)", letterSpacing: "0.04em" }}>
        ...
        <div className="glass grad-border p-6">
          <div className="flex items-center justify-between mb-1">
            <h2 className="font-heading text-xl" style={{ color: "var(--text)", letterSpacing: "0.04em" }}>
